...
|[2](https://github.com/maherharb/MATE-T580/blob/master/Lectures/Lesson_02_Data_Cleaning_github.md)</BR>(4/9)|We'll continue building on the work done in the previous week. However, we'll start to pay more attention to the structure of the data and what it means to have 'tidy data'.|<ul><li>Cleaning Data in R</li></ul>
...
|[5](https://github.com/maherharb/MATE-T580/blob/master/Lectures/Lesson_05_Statistical_Inference_github.md)</BR>(4/30)|We'll get introduced to important concepts in statistical learning including the bias-variance trade off, learning curves, feature selection, regularization, and cross validation.|<ul><li>Correlation and Regression</li></ul>
